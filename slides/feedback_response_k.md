...
**Acknowledged** - Excellent feedback on directory safety. Robust script execution requires explicit path management. I will implement the remediation to ensure production-grade reliability.
...
**Remediation Summary**: Added explicit `EXPORT_DIR` creation (`mkdir -p "$EXPORT_DIR"`) before image export operations, ensuring zero failure risk from missing paths. This completes the atomic workflow requirement with full path validation.

https://www.kimi.com/share/19aa5d3c-dcb2-82a0-8000-00005edc1aaf
