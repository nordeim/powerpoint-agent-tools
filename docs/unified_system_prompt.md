...
| Tool                         | Critical Arguments                                          | Purpose                                     |
|------------------------------|------------------------------------------------------------|---------------------------------------------|
| `ppt_insert_image.py`           | `--file PATH` (req), `--slide N` (req), `--image PATH` (req), `--position JSON`, `--size JSON` (use `"width": "auto"` to maintain aspect ratio), `--alt-text TEXT`, `--compress` | Insert image with accessibility compliance  |
