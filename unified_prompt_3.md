...
| Tool                         | Critical Arguments                                          | Purpose                                     |
|------------------------------|------------------------------------------------------------|---------------------------------------------|
| `ppt_add_image.py`           | `--file PATH` (req), `--slide N` (req), `--image PATH` (req), `--position JSON`, `--size JSON`, `--alt-text TEXT`, `--compress` | Insert image with accessibility compliance  |
...
| Tool                         | Critical Arguments                                          | Purpose                                     |
|------------------------------|------------------------------------------------------------|---------------------------------------------|
| `ppt_add_shape.py`           | `--file PATH` (req), `--slide N` (req), `--shape-type {rectangle,rounded_rectangle,ellipse,triangle,arrow_right,star}` (req), `--position JSON`, `--size JSON`, `--fill-color HEX`, `--line-color HEX` | Add geometric elements |
...
| `ppt_set_background.py`      | `--file PATH` (req), `--slide N`, `--color HEX`, `--image PATH` | Set slide background                        |
...
2. **Readability Overlay** (for text on images):
   ```bash
   ppt_add_shape.py --file PATH --slide N --shape-type rectangle \
